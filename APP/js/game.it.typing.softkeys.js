    ...
    $.fn.softkeys = function(options) {
        ...
        var createRow = function(obj, buttons) {
            ...
            createButton = function(obj, button) {
                ...
                obj.append('<'+settings.buttonWrapper+' class="' + btnClass + ' js-' + character + ' ' + styleClass+'" data-type="'+type+'">'+character+'</'+settings.buttonWrapper+'>');
            },
